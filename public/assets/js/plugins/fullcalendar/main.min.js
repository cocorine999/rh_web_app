...
var FullCalendar = (function (e) {
    ...
    function Ue(e) {
        e.classList.add("fc-unselectable"),
            e.addEventListener("selectstart", ke);
    }
    function Le(e) {
    ...
    function Be(e, t, n) {
        return n.func
            ? n.func(e, t)
            : je(e[n.field], t[n.field]) * (n.order || 1);
    }
    function je(e, t) {
        return e || t
            ? null == t
    ...
    function Rt(e, t, n) {
        ...
        a)) {
            ...
            if (u.recurringDef) {
                ...
                for (
                    var d = 0, p = _t(u, c, t, r, o.recurringTypes);
                    d < p.length;
                    d++
                ) {
                    var f = p[d],
    ...
    function Wt(e) {
        return (
            Ge(e.getUTCHours(), 2) +
            ":" +
            Ge(e.getUTCMinutes(), 2) +
            ":" +
            Ge(e.getUTCSeconds(), 2)
        );
    }
    function Vt(e, t) {
        void 0 === t && (t = !1);
    ...
    var jt = {
        ...
        $t = (function () {
            function e(e) {
                ...
                for (var o in e)
                    o in jt
                        ? ((n[o] = e[o]), (r = Math.max(jt[o], r)))
                        : ((t[o] = e[o]), o in Gt && (r = Math.max(Gt[o], r)));
    ...
    function On(e, t) {
        ...
        return (
            e.start && ((n = ot(e.start)), r && r <= n && (r = $e(n, 1))),
            { start: n, end: r }
        );
    }
    function An(e) {
    ...
    function Un(e, t, n, r) {
        return "year" === r
            ? xt(n.diffWholeYears(e, t), "year")
            : "month" === r
            ? xt(n.diffWholeMonths(e, t), "month")
            : tt(e, t);
    }
    function Ln(e, t) {
        var n,
            ...
            o = [],
            i = t.start;
        for (e.sort(Wn), n = 0; n < e.length; n += 1)
    ...
    function fr(e, t) {
        ...
        return (
            r(
                ...
                ((n = e),
                (o = t.dateEnv),
                r(r({}, cr(n.range, o, n.allDay)), { allDay: n.allDay }))
            ),
            i
        );
    }
    function hr(e, t, n) {
        ...
        return (
            e
                ? ((i = ot(i)), (i = r.add(i, o.defaultAllDayEventDuration)))
    ...
    function mr(e, t, n, o, i) {
        ...
        return (
            ...
            t.allDay &&
                (u.range = { start: ot(u.range.start), end: ot(u.range.end) }),
            u.range.end < u.range.start &&
                (u.range.end = hr(t.allDay, u.range.start, i)),
            u
        );
    }
    var yr = (function () {
            ...
            return (
                ...
                (e.prototype.today = function () {
                    ...
                    this.unselect(),
                        this.dispatch({
                            type: "CHANGE_DATE",
                            dateMarker: br(e.calendarOptions.now, e.dateEnv),
                        });
                }),
    ...
    var Ir = (function () {
            ...
            return (
                ...
                (e.prototype.offsetForMarker = function (e) {
                    return "local" === this.timeZone
                        ? -lt(ut(e)).getTimezoneOffset()
                        : "UTC" === this.timeZone
                        ? 0
                        : this.namedTimeZoneImpl
                        ? this.namedTimeZoneImpl.offsetForArray(ut(e))
                        : null;
                }),
    ...
    function Lr(e) {
        ...
        return new Ir(
            r(r({ timeZone: an.timeZone, calendarSystem: "gregory" }, e), {
                locale: t,
            })
        );
    }
            ...
            return (
                (e.prototype.splitProps = function (e) {
                    var t = this,
                        ...
                        u = {};
                    for (var c in ((this.eventUiBuilders = mt(
                        n,
                        function (e, n) {
                    ...
                    if (e) {
                        var n = this._splitEventStore(
                            ...
                            i = function (r) {
                                t[r] ||
                                    (t[r] = {
                                        affectedEvents: n[r] || Zr,
                                        mutatedEvents: o[r] || Zr,
                                        isEvent: e.isEvent,
                                    });
                            };
                        for (var a in n) i(a);
    ...
    var xo = (function (e) {
        ...
        return (
            ...
            (t.prototype.shouldComponentUpdate = function (e, t) {
                return (
                    this.debug &&
                        console.log(Dt(e, this.props), Dt(t, this.state)),
            ...
            function t() {
                ...
                return (
                    ...
                    (t.handleRootEl = function (e) {
                        No(t.rootElRef, e),
                            t.props.elRef && No(t.props.elRef, e);
                    }),
                    t
                );
            }
    ...
    var zo = (function (e) {
            ...
            return (
                ...
                (t.prototype.getInnerContent = function () {
                    ...
                    return (
                        void 0 === t && (t = qo(e.defaultContent, e.hookProps)),
                        null == t ? null : t
                    );
                }),
            ...
            function (e) {
                return (function (e, t, n, o, i) {
                    ...
                    return {
                        ...
                        buttonTextDefault:
                            p(i) || e.defaults.buttonText || p(an) || e.type,
                    };
                })(e, a, t, n, o);
            }
        );
    ...
    var Jo = (function () {
        function e(e) {
            (this.props = e),
                (this.nowDate = br(e.nowInput, e.dateEnv)),
                this.initHiddenDays();
        }
        return (
            ...
            (e.prototype.buildCurrentRangeInfo = function (e, t) {
                ...
                return (
                    r.duration
                        ...
                        : ((i = At((o = this.getFallbackDuration())).unit),
                          (a = this.buildRangeFromDuration(e, t, o, i))),
            ...
            (e.prototype.adjustActiveRange = function (e) {
                ...
                return (
                    r &&
                        (Nt(o) < 0 && ((a = ot(a)), (a = n.add(a, o))),
                        Nt(i) > 1 &&
                            ((s = $e((s = ot(s)), -1)), (s = n.add(s, i)))),
                    { start: a, end: s }
                );
            }),
            (e.prototype.buildRangeFromDuration = function (e, t, n, r) {
                ...
                return (
                    Nt(n) <= 1 &&
                        this.isHiddenDay(o) &&
                        (o = ot((o = this.skipHiddenDays(o, t)))),
                    d(),
    ...
    function ei(e, t, n, o) {
        ...
        switch (t.type) {
            ...
            case "FETCH_EVENT_SOURCES":
                return oi(
                    e,
                    t.sourceIds ? yt(t.sourceIds) : ai(e, o),
                    s,
                    t.isRefetch || !1,
                    o
                );
    ...
    function vi(e, t, n, r, o) {
        ...
        return {
            headerToolbar: e.headerToolbar
                ? gi(e.headerToolbar, e, t, n, r, o, i)
                : null,
            footerToolbar: e.footerToolbar
                ? gi(e.footerToolbar, e, t, n, r, o, i)
                : null,
            viewsWithButtons: i,
        };
    }
    ...
    function Ei(e, t) {
        for (
            var n = Et(t.getCurrentData().eventSources), r = [], o = 0, i = e;
            o < i.length;
            o++
        ) {
        ...
        Oo({
            ...
            propSetHandlers: {
                dateProfile: function (e, t) {
                    t.emitter.trigger(
                        "datesSet",
                        r(r({}, ur(e.activeRange, t.dateEnv)), {
                            view: t.viewApi,
                        })
                    );
                },
        ...
        wi = (function () {
            function e(e, t) {
                (this.runTaskOption = e),
                    ...
                    (this.queue = []),
                    (this.delayedRunner = new Ci(this.drain.bind(this)));
            }
            return (
    ...
    var _i = (function () {
        function e(e) {
            ...
            (this.computeOptionsData = zt(this._computeOptionsData)),
                (this.computeCurrentViewData = zt(
            ...
            Hi(g, p) && this.emitter.trigger("loading", !0),
                (this.state = g),
                this.updateData(),
        ...
        return (
            ...
            (e.prototype.processRawCalendarOptions = function (e, t) {
                var n = pn([an, e, t]),
                    ...
                    c = (this.currentCalendarOptionsRefiners = r(
                        r(r(r(r({}, on), sn), ln), u.listenerRefiners),
                        u.optionRefiners
                    )),
                    d = {},
                    p = pn([an, l, e, t]),
                ...
                for (var m in p)
                    "plugins" !== m &&
                        (p[m] === h[m] || (un[m] && m in h && un[m](h[m], p[m]))
                            ? (f[m] = v[m])
                            : c[m]
                            ? ((f[m] = c[m](p[m])), (g = !0))
                            : (d[m] = h[m]));
            ...
            (e.prototype.processRawViewOptions = function (e, t, n, o, i) {
                var a = pn([an, e.optionDefaults, n, o, e.optionOverrides, i]),
                    s = r(
                        r(r(r(r(r({}, on), sn), ln), dn), t.listenerRefiners),
                        t.optionRefiners
                    ),
                    l = {},
            ...
            return (
                ...
                (e.prototype.insertEntryAt = function (e, t) {
                    var n = this.entriesByLevel,
                        r = this.levelCoords;
                    -1 === t.lateral
                        ? (Gi(r, t.level, t.levelCoord), Gi(n, t.level, [e]))
                        : Gi(n[t.level], t.lateral, e),
    ...
    var fa = (function (e) {
        ...
        va = (function (e) {
            function t(t, n) {
                ...
                return (
                    (r.initialNowDate = br(n.options.now, n.dateEnv)),
            ...
            return (
                ...
                (e.prototype.sliceEventRange = function (e, t) {
                    ...
                    this.forceDayIfListItem &&
                        ...
                        (n = { start: n.start, end: $e(n.start, 1) });
                    for (
            ...
            !(
                ...
                !(function (e, t, n, o) {
                    ...
                    for (var m in u) {
                        var y = u[m],
                            ...
                            S = c[y.defId],
                            D = l[y.defId];
                        if (!Ta(S.constraints, E, d, e.businessHours, t))
                            return !1;
                ...
                !(
                    ...
                    !(function (e, t, n, o) {
                        ...
                        o && (c = o(c));
                        if (!Ta(c.constraints, u, i, e.businessHours, t))
                            return !1;
                        ...
                        for (var f in s) {
                            ...
                            if (zn(u, h.range)) {
                                ...
                                if (p && !p(new wr(t, a[h.defId], h), null))
                                    return !1;
                            }
                        }
                        for (var v = 0, g = c.allows; v < g.length; v++) {
                            if (!(0, g[v])(fr(r(r({}, n), l), t), null))
                                return !1;
                        }
                        return !0;
                    })(e, t, n, o)
        ...
        return (
            ...
            (t.prototype.render = function () {
                ...
                return yo(
                    ...
                    Boolean(!v && p.length) &&
                        yo.apply(void 0, o(["thead", {}], p)),
                    Boolean(!v && f.length) &&
                        yo.apply(void 0, o(["tbody", {}], f)),
                    Boolean(!v && h.length) &&
                        yo.apply(void 0, o(["tfoot", {}], h)),
                    v && yo.apply(void 0, o(o(o(["tbody", {}], p), f), h))
                );
            }),
            (t.prototype.renderSection = function (e, t) {
                return "outerContent" in e
                    ? yo(Do, { key: e.key }, e.outerContent)
                    : yo(
                          "tr",
                          {
                              key: e.key,
            ...
            (t.prototype.computeShrinkWidth = function () {
                return Fa(this.props.cols)
                    ? Ha(this.scrollerElRefs.getAll())
                    : 0;
            }),
    ...
    Ya.addStateEquality({
        scrollerClientWidths: St,
        scrollerClientHeights: St,
    });
    var Za = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this;
    ...
    function es(e) {
        ...
        return r(
            r(r({ date: n.toDate(t), view: e.viewApi }, o), {
                dayNumberText: e.showDayNumber ? n.format(t, Ja) : "",
            }),
            e.extraProps
        );
    }
    var ts = (function (e) {
        function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            return (
                (t.refineHookProps = Bt(es)), (t.normalizeClassNames = jo()), t
            );
        }
        return (
            n(t, e),
    ...
    function os(e) {
        return (
            e.event.title &&
            yo("div", { className: "fc-event-title" }, e.event.title)
        );
    }
    var is = function (e) {
        return yo(To.Consumer, null, function (t) {
    ...
    function ds(e) {
        if (e.allDayDate)
            return { start: e.allDayDate, end: $e(e.allDayDate, 1) };
        var t,
            n = e.hiddenSegs;
        return {
            start: ps(n),
            end: ((t = n), t.reduce(hs).eventRange.range.end),
        };
    }
    function ps(e) {
        ...
        Es = (function () {
            function e(e) {
                ...
                (this.subjectEl = null),
                    ...
                    1 === (ms += 1) &&
                        window.addEventListener("touchmove", Ss, {
                            passive: !1,
                        });
            }
            return (
                (e.prototype.destroy = function () {
                    this.containerEl.removeEventListener(
                        ...
                        (ms -= 1) ||
                            window.removeEventListener("touchmove", Ss, {
                                passive: !1,
                            });
                }),
    ...
    function Ms(e, t) {
        return (
            (!e && !t) ||
            (Boolean(e) === Boolean(t) && lr(e.dateSpan, t.dateSpan))
        );
    }
    function Ps(e, t) {
        for (
            ...
            function t(t) {
                ...
                (n.dragSelection = null),
                    ...
                    (n.handlePointerUp = function (e) {
                        n.dragSelection &&
                            (pr(n.dragSelection, e, n.component.context),
                            (n.dragSelection = null));
                    });
        ...
        function t(t) {
            ...
            (n.draggingSegEl = null),
                ...
                (n.handleHitUpdate = function (e, t, r) {
                    ...
                    l &&
                        ((u = vr(i, o.getCurrentData().eventUiBases, l, o)),
                        (d.mutatedEvents = u),
                        Ca(d, e.dateProfile, o) ||
                            ((c = !0),
                            (l = null),
                            (u = null),
                ...
                (this.context = e),
                    ...
                    (this.onDocumentPointerDown = function (e) {
                        ...
                        (t.matchesCancel = !!Se(r, n)),
                            (t.matchesEvent = !!Se(r, Hs.SELECTOR));
                    }),
            ...
            (t.prototype.render = function () {
                var e = this.props,
                    t = this.context.options.navLinks
                        ? { "data-navlink": Qr(e.date), tabIndex: 0 }
                        : {};
                return yo(
                    Qa,
                    {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    var e = this,
                        ...
                        s = t.dateProfile,
                        l = i.navLinks
                            ? { "data-navlink": Qr(a, "week"), tabIndex: 0 }
                            : {};
                    return yo(
                        ts,
                        {
                    ...
                    if (!t.forPrint && null !== t.clientWidth) {
                        if (e) {
                            ...
                            if (r.length) {
                                ...
                                this.setState({
                                    framePositions: new po(o, r, !0, !1),
                                });
                            }
                        }
                        var i =
                            !0 === t.dayMaxEvents || !0 === t.dayMaxEventRows;
                        this.setState({
                            eventInstanceHeights:
                                this.queryEventInstanceHeights(),
                            maxContentHeight: i
            ...
            var r = n.dateEnv,
                ...
                a =
                    null == o.slotLabelFormat
                        ...
                        ? rn(o.slotLabelFormat[0])
                        : rn(o.slotLabelFormat),
                s = {
                    level: 0,
                    time: e.time,
            ...
            return (
                (e.prototype.safeComputeTop = function (e) {
                    ...
                    if (jn(t.currentRange, e)) {
                        ...
                        if (r >= Ht(t.slotMinTime) && r < Ht(t.slotMaxTime))
                            return this.computeTimeTop(xt(r));
                    }
                    return null;
                }),
                (e.prototype.computeDateTop = function (e, t) {
                    return (
                        t || (t = ot(e)),
                        this.computeTimeTop(xt(e.valueOf() - t.valueOf()))
                    );
                }),
                (e.prototype.computeTimeTop = function (e) {
                    var t,
                        ...
                        i = r.els.length,
                        a =
                            (e.milliseconds - Ht(o.slotMinTime)) /
                            Ht(this.slotDuration);
                    return (
                        (a = Math.max(0, a)),
                        (a = Math.min(i, a)),
                        (t = Math.floor(a)),
    ...
    var $l = (function (e) {
        function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            return (
                (t.buildTimeColsModel = zt(Jl)), (t.buildSlatMetas = zt(Kl)), t
            );
        }
        return (
            n(t, e),
    ...
    function tu(e) {
        ...
        return yo(
            Do,
            null,
            e.text && yo("a", r({ className: "fc-list-day-text" }, t), e.text),
            e.sideText &&
                yo(
                    "a",
                ...
                return yo(va, { unit: "day" }, function (e, n) {
                    for (var s = [], l = 0; l < a.length; l += 1) {
                        ...
                        if (u) {
                            ...
                            s.push(
                                yo(eu, { key: c, dayDate: t[l], todayRange: n })
                            );
                            for (
                                var d = 0, p = (u = $n(u, i.eventOrder));
                                d < p.length;
                                d++
                            ) {
                                var f = p[d];
    ...
    function lu(e) {
        for (
            ...
            r.push(t), o.push({ start: t, end: $e(t, 1) }), (t = $e(t, 1));
                            ...
                            p = (function (e, t, n, o) {
                                ...
                                o.canComputeOffset
                                    ? ((a = o.formatIso(e.start)),
                                      (s = o.formatIso(e.end)))
                                    : ((a = $e(e.start, -1).toISOString()),
                                      (s = $e(e.end, 1).toISOString()));
                                (i = r(r({}, n || {}), {
                                    key: t,
                                    timeMin: a,
                                    timeMax: s,
